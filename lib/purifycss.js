...
var SelectorFilter = function () {
    function SelectorFilter(contentWords, whitelist, blacklist) {
    ...
    createClass(SelectorFilter, [{
        ...
        key: "parseWhitelist",
        value: function parseWhitelist(whitelist, patternList) {
            var _this = this;
            ...
            whitelist.forEach(function (whitelistSelector) {
                if (isWildcardWhitelistSelector(whitelistSelector)) {
                    ...
                    patternList.push(whitelistSelector.substr(1, whitelistSelector.length - 2));
